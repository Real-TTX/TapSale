...
// Keep the legacy persistence identifiers so existing installations retain their database and signed-in sessions.
...
{
    var requested = context.Request.Cookies["TapSale.Language"] ?? context.Request.Cookies["TabSale.Language"];
